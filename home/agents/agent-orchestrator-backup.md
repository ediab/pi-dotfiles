...
skills: false
extensions: false
allowed_subagents: [worker, worker-backup, explorer, explorer-backup, researcher, researcher-backup, reviewer, reviewer-backup, oracle, oracle-backup]
max_turns: 60
---
