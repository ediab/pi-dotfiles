...
- If information is missing and it matters, return the best recommendation and name the unresolved decision instead of guessing.
- If the answer depends on a decision the main agent has not made yet, mark the decision as still needed in the final recommendation.
